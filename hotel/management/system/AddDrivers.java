...
public class AddDrivers extends JFrame implements ActionListener
{
    ...
    AddDrivers()
    {
        ...
        ImageIcon i1 = new ImageIcon("C:\\Users\\USER\\Documents\\eclipse-workspace\\Hotel Management System\\src\\icons\\eleven.jpg");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if (ae.getSource() == add)
        {
            ...
            {
                conn conn = new conn();
                String str = "insert into driver(name, age, gender, company, brand, available, location) values('"+name+"', '"+age+"', '"+gender+"', '"+company+"', '"+brand+"', '"+available+"', '"+location+"')";
